...
> ⚠ **현재 `EditorBuildSettings` 순서는 표와 다르다** — `DebugLobby 0 · Title 1 · Lobby 2 · Room 3 · Game 4` (2026-09-23 `bbf48bc`). 이대로 빌드하면 시작 씬이 디버그 로비다. 테스트 빌드 전 Title 을 0 으로 되돌린다 (B5-1 확인 항목).
