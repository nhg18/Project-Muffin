...
- 기획 모순 (사용자 결정 필요): 처치 승리 판정 시점(02 "즉시" vs 07 "모든 연쇄 뒤"), 찹츄 선언 시점(07 가정 "언제든" vs 재선언 "자신의 턴"), `versioning` MVP `0.6` vs 플랜 `0.5.0`, 게임 중 이탈 표기(01 제안 · 02 확정 · 01 §7 미정 — 4-1 #7 로 11/18 결정).
