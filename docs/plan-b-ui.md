...
| B1-12 | `SceneLoader` 도입, `async void` 제거 | PR3 | ✅ `feature/scene-loader` (`async void` 는 `NicknameInput` 삭제로 이미 없음) |
...
| B2-7 | 로비 · 방 정리 | `ui-refactoring-plan` PR5 · PR6. PR6 은 ←A 요청 R-1 · R-3 |
